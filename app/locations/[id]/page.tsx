...
const LocationDetail = async ({ params }: { params: { id: string } }) => {
    try {
        ...
        return (
            <section className="max-w-7xl mx-auto px-4 py-6 bg-gray-50 min-h-screen">
                {/* Hero Section */}
                ...
                {/* Quick Info Bar */}
                <div className="bg-white rounded-xl shadow-md p-4 mb-8 flex flex-wrap gap-4 justify-between">
