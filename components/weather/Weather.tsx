...
//                   </div>
//                   <div>
//                     <p className="text-sm text-gray-500 dark:text-gray-400">รู้สึกเหมือน</p>
...
//                   </div>
//                   <div>
//                     <p className="text-sm text-gray-500 dark:text-gray-400">ทัศนวิสัย</p>
...
export default function Weatherapi() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 bg-gradient-to-r from-blue-600/90 via-purple-600/90 to-pink-600/90 backdrop-blur-xl p-8 rounded-3xl mb-8 max-w-auto w-full shadow-2xl border border-white/20">
        <div className="text-center space-y-4">
          {/* Main Title */}
          <div className="flex items-center justify-center space-x-4 mb-4">
            <div className="text-5xl animate-pulse">🏛️</div>
            <h1 className="text-4xl lg:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white via-yellow-200 to-orange-200 drop-shadow-2xl">
              บุรีรัมย์ สยามเฮอริเทจ
            </h1>
