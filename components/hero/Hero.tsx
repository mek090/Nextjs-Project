...
const Hero = ({ locations }: { locations: LocationCardProps[] }) => {
    ...
    if (!locations || locations.length === 0) {
        return (
            <div className="relative w-full h-[300px] sm:h-[400px] lg:h-[500px] xl:h-[600px] bg-gray-200 animate-pulse">
    ...
    return (
        <div className="relative h-[300px] sm:h-[400px] lg:h-[500px] xl:h-[600px] w-full">
            <Swiper
                ...
                navigation={{
                    enabled: window.innerWidth > 768, // ซ่อน navigation ใน mobile
                }}
                ...
                {featuredLocations.map((location, index) => (
                    <SwiperSlide key={location.id}>
                        <div className="relative h-full w-full">
                            ...
                            <div className="absolute inset-x-0 bottom-0 flex items-end p-4 sm:p-6 lg:p-8 bg-gradient-to-t from-black/60 to-transparent">
